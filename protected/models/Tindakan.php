...
class Tindakan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('namaTindakan', 'required'),
			array('namaTindakan', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, namaTindakan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pasiens' => array(self::HAS_MANY, 'Pasien', 'idTindakan'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('namaTindakan',$this->namaTindakan,true);
